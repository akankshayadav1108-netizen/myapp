...
import { Pencil, Trash2, UserX, KeyRound } from "lucide-react";

export default function AllEmployee() {
  const data = [
    { name: "Aman Gupta", email: "aman@gmail.com", dept: "Sales", status: "Active" },
    { name: "Sneha Verma", email: "sneha@gmail.com", dept: "HR", status: "Inactive" },
  ];
            ...
            {data.map((item, i) => (
              ...
              >
                ...
                <td className="p-4 flex gap-4 justify-center">
                  ...
                  <KeyRound className="text-yellow-600 hover:text-yellow-700 cursor-pointer" />
